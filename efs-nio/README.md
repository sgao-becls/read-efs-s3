...
Four 384 well plates (Many files)	1496	6100	48KB	Density Dot	2992	12561	1	False	2
...
fio --ioengine=libaio --iodepth=8 --readwrite=write --numjobs=2 --bs=4k --filesize=48K --name=four_384_well_plates --directory=/home/ec2-user/efs --filename_format='$jobname.$jobnum'
