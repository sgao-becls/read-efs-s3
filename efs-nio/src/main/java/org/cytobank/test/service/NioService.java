...
//        doubleBuffer.rewind();
    ...
    System.out.println(String.format("%d thread - buffer size: %d, file size: %.2fKB, duration: %.2fms, throughput: %.2fKB/s\n", index, bufferSize, fileSizeKB, duration / 1000d / 1000d, throughput));
  }
